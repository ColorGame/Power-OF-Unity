...
Shader "Custom/StencilMask"
{
    ...
    SubShader
    {
        Tags {"Queue"="Transparent" "RenderType"="Transparent" "Queue"="Geometry-1" "RenderPipeline" = "UniversalPipeline"} // "Queue"="Geometry-1" - очередь на рендер, чтоб значение в буфер записывалось раньше всех
