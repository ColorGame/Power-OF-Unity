...
public class PlacedObject : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    ...
    private List<EquipmentSlot> _canPlacedOnSlotList;// Слоты экипировки где можно разместить наш объект   
    ...
    /// </summary>
    public List<EquipmentSlot> GetCanPlacedOnGridList() { return _canPlacedOnSlotList; }
