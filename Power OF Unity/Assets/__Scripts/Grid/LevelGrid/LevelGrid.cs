...
public class LevelGrid : MonoBehaviour // Основной скрипт который управляет СЕТКОЙ данного УРОВНЯ . Оснавная задача Присвоить или Получить определенного Юнита К заданной Позиции Сетки
{
    ...
    [SerializeField] private LevelGridParameters _gridParameters;
    ...
    {     
        ...
        {
            GridSystemXZ<GridObjectUnitXZ> gridSystem = new GridSystemXZ<GridObjectUnitXZ>(_gridParameters, // ПОСТРОИМ СЕТКУ 10 на 10 и размером 2 еденицы на этаже _floor высотой 3  и в каждой ячейки создадим объект типа GridObjectUnitXZ
