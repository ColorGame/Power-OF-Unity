...
{
    //Заменил на 3 способ реализую в ActionButtonUI и ActionButtonSystemUI
    /*private void StartScene()
    {
        _unitActionSystem.OnBusyChanged += UnitActionSystem_OnBusyChanged; // Подписываюсь на Event и выполним UnitActionSystem_OnBusyChanged, эта фунуция получит от события булевый аргумент
    ...
    /*private void ShowShortTooltipFollowMouse() // Показать
    {
