...
/// <summary>
/// Кнопка выбора дружественного юнита
/// </summary>
public class SelectUnitFriendlyButtonUI : MonoBehaviour
{
    ...
    public void Init(Unit unit, UnitActionSystem unitActionSystem)
    {
        _unit = unit;
    ...
    {
        Unit unit = _unitActionSystem.GetSelectedUnit(); // Выделенный Югит
